...
<body yahoo="fix" alink="#006caa" link="#006caa" text="#000000" bgcolor="#ffffff" style="width:100% !important; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; margin:0 auto; padding:20px 0 0 0; background:#ffffff; min-height:1000px;">
	<div style="margin:0; padding:0; width:100% !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; line-height:145%; text-align:left;">
		...
		<table class="content" width="620" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="font-size: 13px; margin:0 auto; padding:0;<?php echo $break; ?>">
			<tr>
				<td valign="top" class="wrapper" width="620">

					<img style="width: 183px; height: 40px;" src="https://workshop.mirren.com/wp-content/uploads/logo.png">

					<?php the_field('confirmation_email_text', 'option'); ?>
		...
		<center>
			...
			foreach ( $tickets as $ticket ) {
				...
				// Retrieve custom field 'last-name' from database using attendee ID, for display in the attendee name section

				$attendee_id = $ticket['attendee_id'];


				global $wpdb;
				$sql = "SELECT meta_value FROM wp_yw_postmeta WHERE meta_key = '_tribe_tickets_meta' AND (CONVERT(meta_id USING utf8) LIKE '%". $attendee_id ."%' OR CONVERT(post_id USING utf8) LIKE '%". $attendee_id ."%' OR CONVERT(meta_key USING utf8) LIKE '%". $attendee_id ."%' OR CONVERT(meta_value USING utf8) LIKE '%". $attendee_id ."%')";
				$db_results = $wpdb->get_results($sql);
				$attendee_info = $db_results[0]->meta_value;
				$attendee_info_array = unserialize($attendee_info);

				$attendee_last_name = $attendee_info_array['last-name'];
					...
					<tr>
						<td align="center" valign="top" class="wrapper" width="620">
							...
							<table class="inner-wrapper" border="0" cellpadding="0" cellspacing="0" width="620" bgcolor="#f7f7f7" style="margin:0 auto !important; width:620px; padding:0;">
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
											<tr>
												<td valign="top" align="center" width="100%" style="padding: 0 !important; margin:0 !important;">
													<h2 style="color:#3F4685; margin:0 0 10px 0 !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-style:normal; font-weight:700; font-size:26px; letter-spacing:normal; text-align:left;line-height: 100%;">
														<a style="color:#3F4685 !important; text-decoration: none !important;" href="<?php echo esc_url( $event_link ); ?>">
															Mirren <?php echo $event->post_title; ?>
														</a>
													</h2>
										...
										<table class="ticket-details" border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
											<tr>
												<td class="ticket-details" valign="top" align="left" width="100" style="padding: 0; width:100px; margin:0 !important;">
													<h6 style="color:#909090 !important; margin:0 0 10px 0; font-family: 'Helvetica Neue', Helvetica, sans-serif; text-transform:uppercase; font-size:13px; font-weight:700 !important;"><?php esc_html_e( 'Confirmation #', 'event-tickets' ); ?></h6>
												...
												<td class="ticket-details" valign="top" align="left" width="120" style="padding: 0 !important; width:120px; margin:0 !important;">
													...
													<span style="color:#0a0a0e !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:15px;"><?php echo $ticket['holder_name']; ?> <?php echo $attendee_last_name; ?></span>
												</td>
											</tr>
										</table>
								...
								<table border="0" style="padding: 15px;" cellpadding="0" cellspacing="0" width="100%" align="center">
									<tr>
