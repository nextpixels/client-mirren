...
<form method="POST" action="https://mirren.activehosted.com/proc.php" id="_form_31_" class="_form _form_31 _inline-form  " novalidate data-styles-version="5">
  ...
  <input type="hidden" name="or" value="84d49364c8e69a592d4d1d28ad0d1452" />
  <div class="_form-content">
    <div class="_form_element _x58019354 _full_width _clear" >
      <div class="_form-title">
      </div>
    </div>
    <div class="_form_element _x62299842 _full_width " >
    ...
    <div class="_form_element _x23572295 _full_width " >
    ...
    <div class="_form_element _x33751760 _full_width " >
      <label for="field[23]" class="_form-label">
      </label>
      <div class="_field-wrapper">
        <input type="text" id="field[23]" name="field[23]" value="" placeholder="Company" required/>
      </div>
    </div>
...
window.cfields = {"23":"company_name"};
    ...
    const formSupportsPost = false;
        ...
        if (validate_form()) {
            ...
            async function submitForm() {
              ...
              const response = await fetch('https://mirren.activehosted.com/proc.php?jsonp=true', request);
              return response.json();
                ...
                if (formSupportsPost) {
                  ...
                  _load_script('https://mirren.activehosted.com/proc.php?' + serialized + '&jsonp=true', null, true);
                }
        }
        return false;
    };
