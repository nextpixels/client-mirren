...
<?php endif; ?>
		...
		<h2><?php esc_html_e( 'Manage Your Passes', 'woocommerce' ); ?></h2>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="username"><?php esc_html_e( 'Enter email used when purchasing', 'woocommerce' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'woocommerce' ); ?></span></label>
		...
		<?php echo do_shortcode('[mirren_email_only_login]'); ?>
