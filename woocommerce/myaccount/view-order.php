...
?>
<p>
	<a href="<?php echo get_site_url() . '/my-account/orders/'; ?>">« Back to orders</a>
</p>
<p>
<?php
if ( wc_get_order_status_name( $order->get_status() ) == 'Order Placed' ) {
	$new_status = 'Placed';
} else {
...
echo wp_kses_post(
	...
	apply_filters(
		...
		/* translators: 1: order number 2: order date 3: order status */
			...
			//'<mark class="order-status">' . $new_status . '</mark>' // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		),
		$order
	)
);
