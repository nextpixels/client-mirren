...
>
	...
	<div class="tribe-tickets__attendee-tickets">
		...
		<div class="attendees-toggle" style="margin-bottom: 24px;">
			<p style="margin-top: 10px; margin-bottom: 30px;">
				<?php echo get_field( 'add_your_attendees_content', 'options' ); ?>
			</p>
			<input class="tribe-tickets__form-field-label" type="radio" id="attenddees_known_yes" name="attendees_known" value="yes" checked="checked">
			<label for="attenddees_known_yes" style="margin-right: 12px;"><?php echo get_field('attendees_known_option_text','options'); ?></label>
			<input class="tribe-tickets__form-field-label" type="radio" id="attenddees_known_no" name="attendees_known" value="no">
			<label for="attenddees_known_no"><?php echo get_field('attendees_not_known_option_text','options'); ?></label>
			<p style="margin-top: 18px;">
				<?php echo get_field( 'add_your_attendees_note', 'options' ); ?>
			</p>
		</div>
		...
		>
			<label class="tribe-tickets__form-field-label" for="company_name" style="margin-bottom: 4px;">Company Name</label>
			<div class="tribe-tickets__form-field-input-wrapper parent-company" style="margin-top: 4px; margin-bottom: 24px; max-width: 245.5px;">
				<input type="text" id="company_name" class="tribe-common-form-control-text__input tribe-tickets__form-field-input" name="company_name" value="" placeholder="" style="padding: 8px 16px;">
			</div>
			<?php
