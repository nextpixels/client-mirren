...
<div id="tribe-events-content" class="tribe-events-single">
	...
	/*if ( $purchased_v_standard === true || $purchased_v_access === true ) {
		...
		if ( $purchased_v_standard === true && $purchased_v_access === true ) {
			// Both
			echo do_shortcode( '[tribe_tickets_protected_content ticket_ids="178,179"][tribe_tickets post_id="95" ticket_id="4793,4798"][/tribe_tickets_protected_content]' );
			...
			// Standard
			echo do_shortcode( '[tribe_tickets_protected_content ticket_ids="178"][tribe_tickets post_id="95" ticket_id="4793"][/tribe_tickets_protected_content]' );
		}
		echo '</div>';
	}*/
