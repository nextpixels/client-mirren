...
?>
<div class="tribe-tickets__tickets-footer" style="display: block;">

	<div class="tribe-tickets-quantity" style="width: 150px; display: inline-block;">
		<?php $this->template( 'v2/tickets/footer/quantity' ); ?>
	</div>
	
	<?php /* $this->template( 'v2/tickets/footer/total' ); */ ?>
	<?php /*<div class="register-footer-tab-toggles">
	<a href="#" class="js-tab tab-in-person btn btn-bordered js-footer-tab-in-person" data-target="in-person" style="display: none;">Add In-Person Passes</a>
	<a href="#" class="js-tab tab-virtual btn btn-bordered js-footer-tab-virtual" data-target="virtual" style="display: inline-block;">Add Virtual Passes</a>
	</div>*/ ?>
	
	<div class="tribe-tickets__tickets-footer-submit" style="display: inline-block;">
