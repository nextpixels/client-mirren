...
?>
<div <?php tribe_classes( $classes ); ?> style="float:none; width: 100%; max-width: 100%;">
	<form
	...
	>
		...
		<div class="register-row-quantity register-footer-quantity">
			<div class="register-row-quantity-prompt">
			<?php if ($virtual_only) : ?>
				<div class="register-row-quantity-prompt-title">
					<?php echo $register_row_bundle_prompt_title; ?>
					<?php if ($register_row_bundle_prompt_show_info) : ?>
						<a href="#" class="add-more-logins-info" style="margin-left: 8px;"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
					<?php endif; ?>
					<div class="register-row-quantity-prompt-subtext">
						<?php echo $register_row_bundle_prompt_subtext; ?>
					</div>
				</div>
			<?php else : ?>
				<?php echo $register_row_quantity_prompt_in_person; ?>
			<?php endif; ?>
			</div>
